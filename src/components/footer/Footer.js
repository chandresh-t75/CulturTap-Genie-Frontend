        ...
        <div className='w-[100%] flex max-lg:flex-col text-[14px]  max-lg:items-center lg:justify-between lg:pl-[180px] lg:pr-[150px] mt-[50px] pb-[30px] pt-[30px] bg-[#f5f5f5]  '>
            <div className='w-full lg:w-3/5  flex max-sm:flex-col max-sm:pl-[30px]  max-sm:gap-4  lg:justify-between justify-evenly'>
                <div className=''>
                    ...
                    <div className='max-sm:flex flex-col hidden my-2'>
                        ...
                        <p className='flex flex-col '><Link to='/contact/report'> Report Concern </Link>
                ...
                <div className='max-sm:hidden'>
                    ...
                    <p className='flex flex-col '>
                        <Link to='/contact/report'> Report Concern </Link>
                     <Link to='/contact'>Contact Us</Link>
                      <Link to= '/termsandconditions'>Terms and Conditions*</Link></p>
                    <p className='flex mt-[15px] font-bold text-[#2e2c43]'>Careers</p>
                    <p>Open Opportunities</p>
            ...
            <div className='max-lg:w-full flex flex-col max-sm:items-start max-lg:items-center max-sm:pl-[30px]'>
                ...
                <div className='flex gap-2 mt-3 cursor-pointer'>
                    <a href='https://www.facebook.com/share/4JS6Rn4yNNWu8hJA/?mibextid=qi2Omg' className='w-[32px] h-[32px]'>
                        <img src={facebook} alt="logo" loading='lazy' />
                    </a>
                    <a href='https://x.com/Culturtap_Genie?t=iIE9XUCGQggt_Nr2OAn9RA&s=09' className='w-[32px] h-[32px] pt-[2px] cursor-pointer'>
                    ...
                    <a href='https://www.instagram.com/culturtap_genie?igsh=MXNrbTQ5aHdkdzNsbA==' className='w-[32px] h-[32px] cursor-pointer' >
