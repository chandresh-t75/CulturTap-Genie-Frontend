        ...
        if (data.name.length > 0 && data.email.length > 0 && data.mobileNo.length > 0 && data.concern.length > 0) {
            ...
            try {
                ...
                if (details.type === "Contact us!") {
                    ...
                    const res = await axios.post(`${process.env.REACT_APP_API_URL}/contact`,{
                        name: data.name,
    ...
    return (
        <div className='max-lg:pl-[0px] lg:ml-[180px] md:mt-[66px] max-sm:pt-[100px] overflow-hidden'>
            <div className='max-lg:pl-[30px] '>
                <h1 className='text-[38px] heading-color font-extrabold  max-sm:text-[28px]'>{details.type}</h1>
            ...
            <div className='md:mt-[69px] flex max-lg:flex-col-reverse max-lg:items-center md:gap-[100px] lg:gap-[150px] '>
                <form onSubmit={HandleSubmit} className='flex flex-1 flex-col items-center gap-6 z-10'>
                    <div >
                ...
                <div className="flex flex-1 justify-center items-center">
                    <img src={details.img} alt="contact"  className='w-[400px] h-[300px] md:w-[754px] md:h-[540px]  max-md:px-[30px] ' />
                </div>
            </div>
        </div>
    )
